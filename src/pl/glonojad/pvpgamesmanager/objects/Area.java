...
import java.util.*;
public class Area implements Iterable<Block>, Cloneable, ConfigurationSerializable {
...
* @param z2 Z co-ordinate of corner 2
*/
private Area(String worldName, int x1, int y1, int z1, int x2, int y2, int z2) {
...
*/
public Area expand(CuboidDirection dir, int amount) {
switch (dir) {
case North:
return new Area(worldName, x1 - amount, y1, z1, x2, y2, z2);
case South:
return new Area(worldName, x1, y1, z1, x2 + amount, y2, z2);
case East:
return new Area(worldName, x1, y1, z1 - amount, x2, y2, z2);
case West:
return new Area(worldName, x1, y1, z1, x2, y2, z2 + amount);
case Down:
return new Area(worldName, x1, y1 - amount, z1, x2, y2, z2);
case Up:
return new Area(worldName, x1, y1, z1, x2, y2 + amount, z2);
default:
...
*/
public Area shift(CuboidDirection dir, int amount) {
...
*/
public Area outset(CuboidDirection dir, int amount) {
Area c;
switch (dir) {
case Horizontal:
...
*/
public Area inset(CuboidDirection dir, int amount) {
...
*/
public Area getFace(CuboidDirection dir	) {
switch (dir) {
case Down:
return new Area(worldName, x1, y1, z1, x2, y1, z2);
case Up:
return new Area(worldName, x1, y2, z1, x2, y2, z2);
case North:
return new Area(worldName, x1, y1, z1, x1, y2, z2);
case South:
return new Area(worldName, x2, y1, z1, x2, y2, z2);
case East:
return new Area(worldName, x1, y1, z1, x2, y2, z1);
case West:
return new Area(worldName, x1, y1, z2, x2, y2, z2);
default:
throw new IllegalArgumentException("Invalid direction " + dir);
}
}
...
*/
public Area getBoundingCuboid(Area other) {
if (other == null) {
return this;
}
...
return new Area(worldName, xMin, yMin, zMin, xMax, yMax, zMax);
}
/**
